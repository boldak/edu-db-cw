...
|Менеджер|
start;
:Обирає проєкт і натискає кнопку "Створити дошку";

|Система|
:Відкриває форму із полями інформації про дошку;

|Менеджер|
:Заповнює інфoрмацію про дошку: вказує назву та опис;
:Натискає кнопку "Створити"
...
|Менеджер|
start;
:Переходить у розділ "Дошка" та обирає потрібну для видалення дошку;
:Менеджер натискає кнопку "Видалити дошку";

|Система|
:Перевіряє права менеджера на видалення обраної дошки
<font color="red"><b> DeleteBoard_NoRights_EXC;
:Відкриває форму підтвердження видалення дошки;

|Менеджер|
:Вводить назву дошки для підтвердження процесу видалення
...
start;
:Входить у систему;
:Обирає опцію "Редагувати налаштування системи";

|Система|
:Відкриває форму зміни налаштувань системи;
