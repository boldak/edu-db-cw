...
@startuml
    ...
    <font color=000 size=16><b>Передумови:</b> Наявність завдань 
    <font color=000 size=16><b>Результат:</b> Вдалий перегляд прогресу 
    <font color=000 size=16><b>Виключні ситуації:</b> Немає
    <font color=000 size=16><b>Основний сценарій:</b>
end header
    ...
    |Система|
        : Відкриває сторінку "Управління завданнями";
    |Замовник|   
        : Натискає кнопку "Переглянути прогрес " ;
    |Система|
        : Надає доступ до перегляду прогреса;
    |Замовник|   
        : Перегдлядає прогрес ;
        stop;
@enduml
