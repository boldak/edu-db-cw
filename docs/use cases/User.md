## Сценарії для  користувача даних
...
@startuml
    ...
    |Система|
        ...
        створити графік із заданих даних
        end note
...
@startuml
    ...
    |Система|
        ...
        створити діаграму із заданих даних
        end note
        :наносить точки на площину;
...
@startuml
    ...
    |Система|
        :отримує введені користувачем дані пошуку;
        note right #ffaaaa
        <b>Можливо
        ...
        критеріями пошуку не знайдено.
        end note
        :фільтрує знайдені дані за обраними користувачем критеріями;
        :сортує знайдені набори даних за певним критерієм;
