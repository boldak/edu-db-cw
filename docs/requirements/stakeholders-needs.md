...
**FURPS**[[2]](#link2) - модель для класифікації якості програмного забезпечення. До неї входить: функціональність (**F**unctionality), практичність(**U**sability), надійність(**R**eliability), продуктивність(**P**erformance) та експлуаційну придатність(**S**upportability)

**FAQ**[[2]](#link3) - список поширених запитань та відповіді на них.
...
<table>
 ...
 <tr>
   <td>3. Користувач вводить дані для авторизації</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>3. Система відображує список можливих форматів даних (таблиця, графік)</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>6. Система запитує підтвердження на відправлення анкети</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>3. Система відображує список даних</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>3. Система відображує список редакторів</td>
 </tr>
 ...
 <tr>
   <td>5. Система відображує історію змін редактора</td>
 </tr>
 ...
 <tr>
   <td>7. Система відображує внесені зміни редактором</td>
 </tr>

 <tr>
   <td>8. Адміністратор переглядає зміни</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>5. Система відображує інформаційний лист відправника</td>
 </tr>
...
<table>
 ...
 <tr>
   <td>5. Система відображує внесені зміни редактором</td>
 </tr>
...
<div style="font-size: 20px; font-weight: bold; margin-top: 15px">Загальний користувач:</div>

- Створення облікового запису;
- Авторизація;
- Пожертвування кошт;

<div style="font-size: 20px; font-weight: bold; margin-top: 15px">Авторизований користувач:</div>
...
- Відправлення кінцевих змін файлів у систему;
