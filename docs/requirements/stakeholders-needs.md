...
| **_ВИКЛЮЧНІ СИТУАЦІЇ:_** | 1. Дані за запитом користувача не були знайдені                                |
...
| **_ПЕРЕДУМОВИ:_**        | 1. Користувач відправив запит на пошук та розмітку тексту                      |
...
| **_ID:_**                | ADM.FILEUPLOAD                                                                 |
| ------------------------ | ------------------------------------------------------------------------------ |
| **_НАЗВА:_**             | Завантажити текстовий файл в систему                                           |
| **_УЧАСНИКИ:_**          | Адміністратор, Система                                                         |
| **_ПЕРЕДУМОВИ:_**        | -                                                                              |
| **_РЕЗУЛЬТАТ:_**         | Файл з'являється у системі                                                     |
| **_ВИКЛЮЧНІ СИТУАЦІЇ:_** | 1. Обране розширення файлу не підтримується системою                           |
|                          | 2. Розмір файлу перевищує максимальний можливий                                |
| **_ОСНОВНИЙ СЦЕНАРІЙ:_** | 1. Адміністратор відправляє запит на завантаження файлу                        | 
|                          | 2. -...                      |
