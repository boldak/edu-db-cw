...
***РЕЗУЛЬТАТ:*** Розробник є учасником проєкту

***ВИКЛЮЧНІ СИТУАЦІЇ:*** 
- *AddMember_EX_NoRights* Користувач не має прав тімліда
- *AddMember_EX_InvalidData* Користувач ввів неправильні дані
- *AddMember_EX_DoNotExist* Розробник не зареєстрований в системі
...
9. Система надсилає сповіщення розробнику про призначення до проєкту
10. Розробник отримує сповіщення про призначення до проєкту
...
5. Користувач натискає на розробника
6. Система перевіряє права користувача (DeleteMember_EX_NoRights)
7. Система відкриває діалогове вікно
8. Користувач натискає на кнопку "Видалити"
9. Система надсилає діалогове вікно з наслідками дії
10. Користувач натискає на кнопку "Підтвердити" (DeleteMember_EX_Canceled)
11. Система надсилає сповіщення про успішне видалення учасника проєкту
12. Користувач отримує сповіщення про успішне видалення учасника проєкту
