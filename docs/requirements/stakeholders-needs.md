...
2. Система розгортає кнопку у розкривний список із такими елементами: канбан-дошка, список, календар
3. Користувач обирає спосіб відображення з розкривного списку (ChangeView_EX_AlreadyChosen)
