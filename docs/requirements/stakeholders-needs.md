...
***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Користувач натискає кнопку "Створити завдання" у розділі завдань (CreateTask_EX_MaxReached)
2. Система просить користувача ввести назву нового завдання у полі вводу
3. Користувач вводить назву нового завдання (CreateTask_EX_Canceled)
4. Система просить користувача ввести опис нового завдання у полі вводу
5. Користувач вводить опис нового завдання (CreateTask_EX_Canceled)
6. Користувач натискає кнопку "Підтвердити" (CreateTask_EX_WrongName)
7. Система створює завдання з назвою, що ввів користувач, у розділі завдань
8. Система сповіщає про успішне створення нового завдання
9. Користувач отримує сповіщення про успішне створення нового завдання
10. Система відображає нове завдання з назвою, що ввів користувач, у блоці розділу завдань
...
6. Користувач вводить нові дані (EditTask_EX_Canceled)
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Користувач натискає кнопку "Видалити завдання"
2. Система просить користувача підтвердити видалення завдання (RemoveTask_EX_Canceled)
3. Користувач натискає кнопку "Підтвердити"
4. Система видаляє завдання
5. Система сповіщає про успішне видалення завдання
6. Користувач отримує сповіщення про успішне видалення завдання
7. Система перестає зображати завдання, яке вже видалила
...
7. Система присуджує користувачеві статус замовник
8. Система повідомляє користувачу про успішне створення проєкту
9. Користувач отримує інформацію про успішне створення проєкту(CreateProject_EX_DeadConnection)
10. Система закриває вікно створення проєкту
11. Система відкриває новостворений проєкт
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Користувач натискає на обраний проєкт
2. Система відкриває вікно проєкту
3. Користувач натискає на кнопку "Додати учасника"
4. Система перевіряє права користувача (AddMember_EX_NoRights)
5. Відкривається вікно для додання учасника
6. Користувач заповнює інформацію (AddMember_EX_InvalidData)
7. Система перевіряє наявність розробника в системі (AddMember_EX_DoNotExist)
8. Користувач натискає кнопку "Підтвердити"
9. Система надсилає сповіщення користувачу про призначення до проєкту
10. Користувач отримує сповіщення про призначення до проєкту
11. Система надсилає сповіщення про успішне призначення розробника
12. Користувач отримує сповіщення про успішне призначення розробника
13. Система закриває вікно додання учасника
14. Система відображає розробника у списку учасників проєкту
...
1. Користувач натискає на обраний проєкт
2. Система відкриває вікно проєкту
3. Користувач натискає на список учасників проєкту
4. Система відкриває список учасників проєкту
...
- *ChangeRights_EX_SameStatus* Обраний користувач вже маж такий статус


***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Замовник/тімлід натискає на обраний проєкт
2. Система відкриває вікно проєкту
3. Замовник/тімлід натискає на список учасників проєкту
4. Система відкриває список учасників проєкту
5. Замовник/тімлід натискає на обраного користувача правою клавішою миші і з випадаючого списка обирає пункт "Змінити права учасника" 
6. Система перевіряє права користувача (ChangeRights_EX_NoRights)
7. Система надсилає діалогове вікно з варіантами нового статусу для обраного користувача: замовник, тімлід, розробник 
8. Замовник/тімлід обирає новий статус для обраного користувача (ChangeRights_EX_SameStatus)
9. Система надсилає сповіщення про успішну зміну статусу обраного користувача
10. Замовник/тімлід отримує сповіщення про успішну зміну статусу обраного користувача
11. Обраний користувач отримує повідомлення про свій новий статус
12. Система відображає користувача з новим статусом у списку учасників проєкту
