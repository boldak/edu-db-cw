...
- CreateTask_EX_WrongDescription Користувач задав невалідний опис для завдання
...
6. Користувач натискає кнопку "Підтвердити" (CreateTask_EX_WrongName / CreateTask_EX_WrongDescription)
...
- EditTask_EX_WrongDescription Користувач задав невалідний опис для завдання

***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Користувач натискає кнопку "Редагувати завдання" у розділі завдань
2. Система просить користувача ввести нову назву для завдання у полі вводу
3. Користувач вводить нову назву завдання (EditTask_EX_Canceled)
4. Система просить користувача ввести новий опис завдання у полі вводу
5. Користувач вводить новий опис завдання (EditTask_EX_Canceled)
6. Користувач натискає кнопку "Підтвердити" (EditTask_EX_WrongName / EditTask_EX_WrongDescription)
7. Система редагує завдання відповідно до нових даних, які ввів користувач
8. Система сповіщає про успішне редагування завдання
9. Користувач отримує сповіщення про успішне редагування завдання
10. Система відображає завдання з новими даними, які ввів користувач, у блоці розділу завдань
