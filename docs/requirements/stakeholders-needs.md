...
|**ВИКЛЮЧНІ СИТУАЦІЇ**:| DС_EX2_1.1 Система не має можливості створити графік із заданих даних.     |
...
|**ВИКЛЮЧНІ СИТУАЦІЇ**:| DP_EX1_2.2 Система видає помилку в разі введеня некоректної інформації     (назва набору даних, ім'я, прізвище та контакти (e-mail) автора набору даних, короткий опис вмісту набору даних, категорія (тег), ключові слова)                                                       |
|**ОСНОВНИЙ СЦЕНАРІЙ**:| 1. Адміністратор натискає кпопку "набори даних".                           |
...
|**ВИКЛЮЧНІ СИТУАЦІЇ:**| DP_EX2_2.3 Обраний файл має однакове ім’я з файлом, що належить набору даних|
