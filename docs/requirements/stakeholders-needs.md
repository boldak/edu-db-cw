...
**РЕЗУЛЬТАТ**: Сторінку перегляду набору даних за заданим тегом.
...
**РЕЗУЛЬТАТ**: Сторінку перегляду наборів даних за заданим фільтром.
...
5. Видавник натискає кнопку "зберегти набір даних". (DP_EX1_1.1)
6. Система створює новий набір даних. (DP_EX1_1.2)
...
6. Видавник натискає кнопку підтвердження видалення набору даних. (DP_EX1_3.1)
...
DP_EX3_1.2 Обраний набір даних вже має такий тег
...
6. Система перевіряє наявність данного тегу в наборі даних. (DP_EX3_1.2)
