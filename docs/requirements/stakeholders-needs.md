...
2. Система відкриває вікно авторизації
3. Користувач вводить адресу електронної пошти (SignIn_EX_NoAccount)
...
2. Система перевіряє права користувача (RemoveTask_EX_NoRights)
3. Система просить користувача підтвердити видалення завдання (RemoveTask_EX_Canceled)
4. Користувач натискає кнопку "Підтвердити"
5. Система видаляє завдання
6. Система сповіщає про успішне видалення завдання
7. Користувач отримує сповіщення про успішне видалення завдання
8. Система перестає зображати завдання, яке вже видалила
