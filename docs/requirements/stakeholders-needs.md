...
- Анотація текстів
- Паралельне редагування під контролем адміністратора
- Збереження анотованих текстів
- Категоризація та фільтри для пошуку необхідних файлів
- Вивантаження анотованих текстів
