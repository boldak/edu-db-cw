...
4. Користувач вводить назву та опис нового завдання (CreateTask_EX_Canceled)
...
3. Користувач обирає із випадаючого списку пункт "Видалити розділ" (DeleteSection_EX_OnlySection)
