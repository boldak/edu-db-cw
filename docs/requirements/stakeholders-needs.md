...
- Клієнт (користувач) - це особа або організація, яка формулює вимоги до проекту та очікує його виконання. Він не взаємодіє безпосередньо з системою управління проектами, але спілкується з нею через бізнес-робітників.
