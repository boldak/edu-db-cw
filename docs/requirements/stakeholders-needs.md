...
| ОСНОВНИЙ СЦЕНАРІЙ: | 1. Користувач преходить в особистий кабінет <br/>2. Користувач натискає на владку "Згадки" в особистому кабінеті <br/>3. Користувач вводить бренд і натискає "пошук"(можливі WRONG_EMAIL,WRONG_PASSWORD)<br/>4. Система зберігає обраний бренд<br/>5. Система обробляє інформацію про згадки та виводить її користувачеві|
