...
6. Система фільтрує знайдені дані за обраними користувачем критеріями (створені в певному часовому проміжку, містять певний тег, регулярність оновлення даних, к-ть переглядів).
7. Система сортує знайдені набори даних за певним критерієм на розсуд системи (за к-тю переглядів, частотою оновлень).
